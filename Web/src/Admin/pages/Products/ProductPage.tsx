...
const ProductPage: React.FC = () => {
  ...
  const viewProductHandler = async (productId: string) => {
    setLoading(true);
    const selectedProduct = await Products.getSingleProduct(productId);
    navigate(ADMIN_ROUTES.VIEWPRODUCT.replace(":id", productId));
    setLoading(false);
  };
      ...
      actions: (
        <div className="grid-actions-btn">
          ...
          <AdminButton
            ...
            color="#4a5759"
            onClick={() => {
              viewProductHandler(product._id);
            }}
          >
            View
          </AdminButton>
